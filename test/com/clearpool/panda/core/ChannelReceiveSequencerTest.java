...
public class ChannelReceiveSequencerTest
{
	...
	public void testSkipPacketAndDequeue() throws IOException
	{
		...
		ChannelReceiveInfo testChannelReceiveInfo = new ChannelReceiveInfo("test1:1000", 1000, "test1:1000", "127.0.0.1", 1, testSelectorThread, 1000, false);
		ChannelReceiveSequencer sequencer = new ChannelReceiveSequencer(testSelectorThread, "test", "test1:1000", "test0", testChannelReceiveInfo, 100, false);
	...
	public void testPacketReceivedMaxDroppedPacketsAllowed() throws IOException
	{
		TestSelectorThread testSelectorThread = new TestSelectorThread();
		ChannelReceiveInfo testChannelReceiveInfo = new ChannelReceiveInfo("test1:1000", 1000, "test1:1000", "127.0.0.1", 1, testSelectorThread, 1000, false);
		ChannelReceiveSequencer sequencer = new ChannelReceiveSequencer(testSelectorThread, "test", "test1:1000", "test0", testChannelReceiveInfo, 2, false);
