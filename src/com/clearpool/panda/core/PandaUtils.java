...
public class PandaUtils
{
	...
	static final int MAX_MESSAGE_PAYLOAD_SIZE = MTU_SIZE - PACKET_HEADER_SIZE - MESSAGE_HEADER_FIXED_SIZE - NETWORK_HEADER_SIZE;
	static final int MAX_PACKET_PAYLOAD_SIZE = MTU_SIZE - PACKET_HEADER_SIZE - NETWORK_HEADER_SIZE;
